...
export default function Services() {
  const services = [
    {
      title: "2D Drafting",
      desc: "High-precision construction drawings and technical documentation."
    },
    {
      title: "3D BIM Modeling",
      desc: "Detailed 3D models for visualization, clash detection, and coordination."
    },
    {
      title: "4D Construction Planning",
      desc: "Time-based simulation to optimize construction sequences."
    },
    {
      title: "5D Cost Estimation",
      desc: "Integrated cost planning and quantity takeoffs using BIM."
    },
  ]

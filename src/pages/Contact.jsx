        ...
        <div className="grid md:grid-cols-2 gap-10">
          ...
          <motion.div initial="hidden" whileInView="show" viewport={{ once: true }} variants={{ hidden: {}, show: { transition: { staggerChildren: 0.15 } } }} className="space-y-6">
            {[
              ...
              { label: "Email", value: "contact@abmdesigntech.com", href: "mailto:contact@abmdesigntech.com" },
            ].map((item, i) => (
              <motion.a
                key={i}
                href={item.href}
                ...
                className="relative group p-6 rounded-2xl border border-white/10 bg-white/5 backdrop-blur-xl transition-all duration-300 hover:shadow-2xl hover:shadow-yellow-500/20 overflow-hidden block"
          ...
          {/* Contact Form */}
          <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.2 }} viewport={{ once: true }} className="relative group p-8 rounded-2xl border border-white/10 bg-white/5 backdrop-blur-xl transition-all duration-300 hover:shadow-2xl hover:shadow-yellow-500/20 overflow-hidden">

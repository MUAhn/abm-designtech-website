      ...
      <div className="max-w-7xl mx-auto px-8 relative">
        ...
        <div className="grid md:grid-cols-2 gap-10">
          <div className="space-y-6">
            <a href="tel:+94772336318" className="block text-lg font-semibold hover:text-yellow-400 focus:outline-none focus:ring-2 focus:ring-yellow-400 rounded">
              📞 +94 77 233 6318
            </a>
            <a href="https://wa.me/94772336318" target="_blank" className="block text-lg font-semibold hover:text-yellow-400 focus:outline-none focus:ring-2 focus:ring-yellow-400 rounded">
              💬 WhatsApp +94 77 233 6318
            </a>
            <a href="mailto:contact@abmdesigntech.com" className="block text-lg font-semibold hover:text-yellow-400 focus:outline-none focus:ring-2 focus:ring-yellow-400 rounded">
